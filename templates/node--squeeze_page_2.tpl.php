...
<div id="countdown" class="<?php print $clocposition; ?>"></div>
	<header>
		...
		if($node->field_header_type['und']['0']['value']==0):
			print '<h2 class="header">"' . $node->field_header_text_2['und'][0]['value'] . '"</h2>';
			...
			method="post">
				...
				<!--field form-->
					<div class="field">
						...
						<input type="submit" class="btn btn-large btn-warning" name="submit" value="<?php print $node->field_submit_text['und'][0]['value']; ?>" onclick="trackEvent('<?php print $node->field_campaign_name['und'][0]['value']; ?>', 'clicked', ''); return false;"
></input>
